...
{
	if (g_strcmp0 (kind, "ich") == 0)
		return FU_INTEL_SPI_KIND_ICH;
	if (g_strcmp0 (kind, "pch") == 0)
		return FU_INTEL_SPI_KIND_PCH;
...
{
	if (kind == FU_INTEL_SPI_KIND_ICH)
		return "ich";
	if (kind == FU_INTEL_SPI_KIND_PCH)
		return "pch";
	return NULL;
}
